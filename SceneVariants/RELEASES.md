...
| 2.1.0 (`82f0a35`) | 2026-09-25 | Scene Variants 2.1.0: a partial-duration scene opens its full-duration variant from a button, or by itself with Always Open on |
| 2.0.4 (`951ed70`) | 2026-09-25 | Dot-prefix the maintainer folders: .tools, .tests, .docs, .dist |
| 2.0.3 (`67095e1`) | 2026-09-24 | Core 3.2.0: Stash's settings page shows every seeded default from its first paint |
| 2.0.2 (`fd916d6`) | 2026-09-24 | Scene Variants 2.0.2: Next Set in the Review Variant Sets footer |
| 2.0.1 (`352b603`) | 2026-09-24 | Scene Variants 2.0.1: every name on a synchronize line carries its hover card |
| 2.0.0 (`c86266d`) | 2026-09-24 | Live-check fixes across Core, Scene Variants, Filename Manager, CFBE and NPT |
| 1.22.0 (`af8d8e3`) | 2026-09-23 | Undo History, step 2: every writing plugin records; the memory tool counts it |
