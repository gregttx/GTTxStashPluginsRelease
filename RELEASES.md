...
| 2026-09-25 |  |  |  |  |  |  |  |  | 2.1.0 (`82f0a35`) |  | Scene Variants 2.1.0: a partial-duration scene opens its full-duration variant from a button, or by itself with Always Open on |
| 2026-09-25 | 3.5.6 (`951ed70`) | 2.5.3 (`951ed70`) | 3.3.2 (`951ed70`) | 3.3.2 (`951ed70`) | 4.2.1 (`951ed70`) | 5.6.2 (`951ed70`) | 5.3.2 (`951ed70`) | 1.5.3 (`951ed70`) | 2.0.4 (`951ed70`) | 2.2.5 (`951ed70`) | Dot-prefix the maintainer folders: .tools, .tests, .docs, .dist |
| 2026-09-24 |  |  |  | 3.3.1 (`0964c6c`) |  |  |  |  |  |  | Core 3.3.1: a merge in Undo History names the tag it went into with its id, as a link |
| 2026-09-24 |  |  |  | 3.3.0 (`c7a24c5`) |  |  |  |  |  |  | Core 3.3.0: Undo History deletes what is ticked, pops back to a point, and names custom fields in teal |
| 2026-09-24 | 3.5.5 (`67095e1`) | 2.5.2 (`67095e1`) |  | 3.2.0 (`67095e1`) |  |  | 5.3.1 (`67095e1`) | 1.5.2 (`67095e1`) | 2.0.3 (`67095e1`) |  | Core 3.2.0: Stash's settings page shows every seeded default from its first paint |
| 2026-09-24 |  |  |  | 3.1.1 (`3130f27`) |  |  |  |  |  |  | Core 3.1.1: a create made in Stash's pages is recorded again |
| 2026-09-24 |  |  |  |  |  |  |  |  | 2.0.2 (`fd916d6`) |  | Scene Variants 2.0.2: Next Set in the Review Variant Sets footer |
| 2026-09-24 |  |  |  |  |  |  |  |  | 2.0.1 (`352b603`) |  | Scene Variants 2.0.1: every name on a synchronize line carries its hover card |
| 2026-09-24 |  |  |  | 3.1.0 (`10b46ee`) |  |  |  |  |  |  | Core 3.1.0: Undo History puts back deletes and merges |
